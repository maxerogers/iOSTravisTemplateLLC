...
security import ./travis/profiles/dev.cer -k $KEY_CHAIN -T /usr/bin/codesign

#security import ./scripts/certs/dist.p12 -k $KEY_CHAIN -P DISTRIBUTION_KEY_PASSWORD  -T /usr/bin/codesign
security import ./travis/profiles/dev.p12 -k $KEY_CHAIN -P password  -T /usr/bin/codesign
